...
class HelixUltimateFeatureContact
{
	...
	{
		$conditions = $this->params->get('contactinfo') && ($this->params->get('contact_phone') || $this->params->get('contact_mobile') || $this->params->get('contact_email') || $this->params->get('contact_time') || $this->params->get('contact_address'));
		...
		if($conditions)
		{
            ...
            {
                $output .= '<li class="sp-contact-address"><span class="fa fa-home"></span> ' . $this->params->get('contact_address') . '</li>';
            }
