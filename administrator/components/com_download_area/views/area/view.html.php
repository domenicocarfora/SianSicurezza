 ...
 * @since  1.6
 */
class Download_areaViewArea extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		$canDo = Download_areaHelper::getActions();

		JToolBarHelper::title(Text::_('COM_DOWNLOAD_AREA_TITLE_AREA'), 'area.png');
		...
		if ($this->state->params->get('save_history', 1) && ('core.edit')) {
			JToolbarHelper::versions('com_download_area.area', $this->item->id);
		}
