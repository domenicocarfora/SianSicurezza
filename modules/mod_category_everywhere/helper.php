...
class modCategoryEverywhereHelper{
    static function getCategories($params){
        $db = JFactory::getDBO();
        $query="SELECT a.id, a.name, a.parent, a.params, jm.path FROM #__zoo_category a JOIN #__menu jm ON a.alias = jm.alias WHERE a.published=1 AND a.application_id=1";
