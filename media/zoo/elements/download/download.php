		...
		if ($layout = $this->getLayout()) {
			return $this->renderLayout($layout,
				array(
					...
					'download_name' => 'Scarica Documentazione',
	...
	public function validateSubmission($value, $params) {
        ...
        // get file from upload
            ...
            try {
				...
				$extensions = array_map(function($ext) { return strtolower(trim($ext)); }, explode(',', $this->config->get('upload_extensions', 'png,jpg,doc,mp3,mov,avi,mpg,zip,rar,gz')));
