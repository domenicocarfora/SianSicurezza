 ...
 * @since  1.6
 */
class BrandpartnerRulesLegacy implements RulesInterface
{
    /**
    ...
    public function build(&$query, &$segments)
    {
        ...
        if (isset($query['id']))
        {
            ...
            if ($view !== null)
            {
				...
				if ($view == 'brandpartner')
				{
					$segments[] = $query['id'];
				}
				if ($view == 'brandpartners')
				{
					$segments[] = $query['id'];
				}
				if ($view == 'brandpartnerform')
				{
					$segments[] = $query['id'];
				}
            }
    ...
    public function parse(&$segments, &$vars)
    {
        ...
        $model        = BrandpartnerHelpersBrandpartner::getModel($vars['view']);
